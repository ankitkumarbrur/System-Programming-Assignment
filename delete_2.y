...
%token DELETE FROM WHERE IDENTIFIER DIGIT FLOAT OPERATOR TOP OR AND IN LIMIT PERCENT LITERAL ORDER BY ASC DESC LOW_PRIORITY QUICK IGNORE AS PARTITION
...
SQL: DELETE FROM IDENTIFIER
    ...
    |DELETE FROM IDENTIFIER ORDER BY O_BY LIMIT DIGIT {                          $7<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER WHERE CONDITION LIMIT DIGIT {                   $7<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $9<0?yyerror():printf("");  }
    ...
    |DELETE OPTIONS FROM IDENTIFIER ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf(""); }
    ...
    |DELETE FROM IDENTIFIER AS IDENTIFIER ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER AS IDENTIFIER WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER AS IDENTIFIER WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf("");  }
    ...
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf(""); }
    ...
    |DELETE FROM IDENTIFIER PARTITION '('P_NAME')' LIMIT DIGIT {                                   $5<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER PARTITION '('P_NAME')' ORDER BY O_BY LIMIT DIGIT {                          $7<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION LIMIT DIGIT {                   $7<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $9<0?yyerror():printf("");  }
    ...
    |DELETE OPTIONS FROM IDENTIFIER PARTITION '('P_NAME')' LIMIT DIGIT {                                   $6<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER PARTITION '('P_NAME')' ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf(""); }
    ...
    |DELETE FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' LIMIT DIGIT {                                   $6<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf("");  }
    ...
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' LIMIT DIGIT {                                   $6<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' ORDER BY O_BY LIMIT DIGIT {                          $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION LIMIT DIGIT {                   $8<0?yyerror():printf("");  }
    |DELETE OPTIONS FROM IDENTIFIER AS IDENTIFIER PARTITION '('P_NAME')' WHERE CONDITION ORDER BY O_BY LIMIT DIGIT {          $10<0?yyerror():printf(""); }
    ;
